...
public class MainActivity extends AppCompatActivity {
    ...
    private MultiAutoCompleteTextView mColorAutoTxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set so that words when seperated by comma is displayed in list
        mColorAutoTxt.setTokenizer(new MultiAutoCompleteTextView.CommaTokenizer());
